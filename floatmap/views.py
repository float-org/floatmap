...
def map(request):
    ...
    epFile = open(os.path.join(settings.BASE_DIR, 'static/geojson/floods/noaa_ex_precip.geojson'))
    apFile = open(os.path.join(settings.BASE_DIR, 'static/geojson/floods/noaa_avg_precip.geojson'))
    context = {
